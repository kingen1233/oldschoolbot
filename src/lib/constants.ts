...
export const Channel = {
	...
	Notifications:
		DISCORD_SETTINGS.Channels?.Notifications ?? "469523207691436042",
	ErrorLogs: DISCORD_SETTINGS.Channels?.ErrorLogs ?? "665678499578904596",
	GrandExchange:
		DISCORD_SETTINGS.Channels?.GrandExchange ?? "682996313209831435",
	...
	BarbarianAssault:
		DISCORD_SETTINGS.Channels?.BarbarianAssault ?? "789717054902763520",
	ChambersOfXeric:
		DISCORD_SETTINGS.Channels?.ChambersOfXeric ?? "835876917252587581",
};
...
export const Roles = {
	...
	BarbarianAssaultMass:
		DISCORD_SETTINGS.Roles?.BarbarianAssaultMass ?? "789724904885846016",
	ChambersOfXericMass:
		DISCORD_SETTINGS.Roles?.ChambersOfXericMass ?? "836539487815204865",
	// Top Roles
	...
	TopSacrificer:
		DISCORD_SETTINGS.Roles?.TopSacrificer ?? "795933981715464192",
	TopMinigamer: DISCORD_SETTINGS.Roles?.TopMinigamer ?? "832798997033779220",
	TopClueHunter:
		DISCORD_SETTINGS.Roles?.TopClueHunter ?? "839135887467610123",
...
export const informationalButtons = [
	new MessageButton()
		.setLabel("Wiki")
		.setEmoji("📰")
		.setURL("https://wiki.oldschool.gg/")
		.setStyle("LINK"),
	new MessageButton()
		.setLabel("Patreon")
	...
	new MessageButton()
		.setLabel("Bot Invite")
		.setEmoji("🤖")
		.setURL("http://invite.oldschool.gg/")
		.setStyle("LINK"),
];
